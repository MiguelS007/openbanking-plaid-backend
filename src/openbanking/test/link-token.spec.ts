...
describe('OpenBankingService', () => {
  ...
  beforeEach(async () => {
    ...
    linkTokenService = moduleRef.get<LinkTokenService>(LinkTokenService);
  });

  it('should be defined', () => {
    expect(linkTokenService).toBeDefined();
  });
});
